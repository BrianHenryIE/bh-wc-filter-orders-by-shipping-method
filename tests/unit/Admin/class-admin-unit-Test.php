 ...
 * @see Admin
 *
 * @package bh-wc-filter-orders-by-shipping-method
 ...
 * Class Admin_Test
 *
 * @covers \BrianHenryIE\WC_Filter_Orders_By_Shipping_Method\Admin\Admin
 */
class Admin_Test extends \Codeception\Test\Unit {
	 ...
	 */
	private $plugin_name = 'bh-wc-filter-orders-by-shipping-method';
	...
	public function test_enqueue_styles() {
		...
		$css_file = $plugin_root_dir . '/admin/css/bh-wc-filter-orders-by-shipping-method-admin.css';
	...
	public function test_enqueue_scripts() {
		...
		$src       = $plugin_root_dir . '/admin/js/bh-wc-filter-orders-by-shipping-method-admin.js';
		$deps      = array( 'jquery' );
		$ver       = $this->version;
		$in_footer = true;
